...
##Analysis Objective
The objective of this analysis is to use car manufacturer's data to predict the time it takes to complete a check on each car before it is released from the manufacturer. The purpose of this prediction is to provide recommendations on how the time for each check can be reduced.
